...
import nuxtjsLogo from '../assets/media/skills/nuxtjs.png';
...
import postgresqlLogo from '../assets/media/skills/postgresql.png';
...
export const skills = reactive([
    ...
    { label: 'postgreSQL', icon: postgresqlLogo, clicked: false },
